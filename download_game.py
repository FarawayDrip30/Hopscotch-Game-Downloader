...
download_file(asset_root + "main.js", "main.js")
...
send_amplitude_code_start = mainjs_string.find("amplitude")
# Add comments
mainjs_string = mainjs_string[:load_amplitude_func_start-1] + "//" + mainjs_string[load_amplitude_func_start-1:send_amplitude_code_start-1] + "//" + [send_amplitude_code_start-1:]
...
# Save HTML
output_file = open(game_name + ".html", "w", encoding="utf-8")
